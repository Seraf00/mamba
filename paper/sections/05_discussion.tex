...
\end{enumerate}
This is a useful baseline point for the field: \PLACE{cross-paper
...
\item \textbf{Pretrained encoders} (TransUNet, UNet-ResNet, Swin-UNet,
      ...
      pretrained encoders. \PLACE{However, in our parameter-matched
      analysis (Paper 2 / supplementary), this advantage shrinks
      substantially.}
...
\item \textbf{No SSM models.} The recent wave of selective state space
      ...
      \PLACE{(cite Paper 2 once arxived)}, and is deliberately excluded
